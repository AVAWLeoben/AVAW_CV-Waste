    ...
    def create_gui(self):
       ...
       # Canvas erstellen
        ...
        def update_label(event=None):
            ...
            step = 0.1
            value = round(slider_var.get() / step) * step
        ...
        slider = ttk.Scale(buttons_frame, from_=0.0, to=1.0, orient='horizontal', variable=slider_var)
        ...
        slider_value = tk.Label(buttons_frame, text=f"{slider_var.get():.1f}")
