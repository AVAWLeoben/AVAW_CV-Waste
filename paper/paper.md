...
![Screenshot of the AVAW CV-Waste graphical user interface.](DEMO/Screenshot_UI.png](https://github.com/AVAWLeoben/AVAW_CV-Waste/blob/JOSS-short-lived-branch/DEMO/Screenshot_UI.png){ width=50% }
